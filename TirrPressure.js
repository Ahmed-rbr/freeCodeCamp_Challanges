// //  Given an array with four numbers representing the tire pressures in
// //   psi of the four tires in your vehicle, and another array of two
// //  numbers representing the minimum and maximum pressure for your
// // tires in bar, return an array of four strings describing each tire's status.
...
function tireStatus(pressuresPSI, rangeBar) {
  const oneBar = 14.5038;
  const minPsi = rangeBar[0] * oneBar;
  const maxPsi = rangeBar[1] * oneBar;
